...
Page({
  ...
  gopages(e) {
    ...
    // if (this.data.jumpother) {/purchase?action=searchBzcl
    switch (e.currentTarget.dataset.gotype) {
      case '营业执照':
        wx.navigateTo({
          url: 'businesslicense?gotype=' + e.currentTarget.dataset.gotype,
        })
        break;
      case '生产许可证':
        wx.navigateTo({
          url: 'productionlicense?gotype=' + e.currentTarget.dataset.gotype,
        })
        break;
      case '卫生许可证':
        wx.navigateTo({
          url: 'hygienelicense?gotype=' + e.currentTarget.dataset.gotype,
        })
        break;
      case 'GMP证书/GSP证书':
        wx.navigateTo({
          url: 'gmp?gotype=' + e.currentTarget.dataset.gotype,
        })
        break;
      case '样品检验报告':
        wx.navigateTo({
          url: 'inspectionreport?gotype=' + e.currentTarget.dataset.gotype,
        })
        break;
      case '质量标准证书':
        wx.navigateTo({
          url: 'standardcertificate?gotype=' + e.currentTarget.dataset.gotype,
        })
        break;
      case '经营授权书':
        wx.navigateTo({
          url: 'authorization?gotype=' + e.currentTarget.dataset.gotype,
        })
        break;
      case '生产批件':
        wx.navigateTo({
          url: 'approval?gotype=' + e.currentTarget.dataset.gotype,
        })
        break;
      case '供货品种':
        wx.navigateTo({
          url: 'supplytype?gotype=' + e.currentTarget.dataset.gotype,
        })
        break;
      case '原料审计':
        wx.navigateTo({
          url: 'detail/materialaudit?gotype=' + e.currentTarget.dataset.gotype,
        })
        break;
      case '包装审计':
        wx.navigateTo({
          url: 'detail/packagingaudit?gotype=' + e.currentTarget.dataset.gotype,
        })
        break;
    }
    // } else {
