...
Page({
  ...
  godplayer: function (e) {
    this.isyuedu(e.currentTarget.dataset.id, e.currentTarget.dataset.isvisited)
    console.log(e)
    wx.navigateTo({
      url: '/packageB/pages/msg/video/player?vido=' + e.currentTarget.dataset.autoname,
  ...
  isyuedu: function (id, isvisited) {
    ...
    let url = app.globalData.url + '/news?action=visitVideoDetail'
    let data = new Object()
  ...
  listData: function () {
    ...
    var page = 1
    let url = app.globalData.url + '/news?action=getBeansVideo&rows=20&page=1'
    let data = new Object()
    app.wxRequest("POST", url, {
  ...
  next: function () {
    ...
    page += 1;
    let url = app.globalData.url + '/news?action=getBeansVideo&rows=20&page=' + page
    let data = new Object()
    app.wxRequest("POST", url, {
