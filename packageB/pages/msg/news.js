...
Page({
  ...
  godetail: function (e) {
    ...
    wx.setStorageSync('newcontent', e.currentTarget.dataset.content)
    wx.navigateTo({
      url: '/packageB/pages/msg/news/detail',
    })
  },
  /**
   * 生命周期函数--监听页面加载
...
this.listData();
  ...
  listData: function () {
    ...
    var page = 1
    let url = app.globalData.url + '/news?action=getBeans&table=xwgg&mobile=true&rows=20&page=1'
    let data = new Object()
    data.typenameEQ='新闻'
    app.wxRequest("POST", url, {
