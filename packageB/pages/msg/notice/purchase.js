...
Page({
  ...
  godetail: function (option) { 
    ...
    wx.navigateTo({
      url: 'purchasedetail?item='+options,
    })
  },
    ...
    listData: function () {
      ...
      var page = 1
      let url = app.globalData.url + '/purchase?action=getPurchaseSP&table=cgd&rows=20&page=1'
      let data = new Object()
      data.spstatusEQ = "0"
    ...
    next: function () {
      ...
      page += 1;
      let url = app.globalData.url + '/purchase?action=getPurchaseSP&table=cgd&rows=20&page=' + page
      let data = new Object()
      data.spstatusEQ = "0"
      app.wxRequest("POST", url, {
        "params": JSON.stringify(data)
