...
Page({
  ...
  //获取详情
    ...
    getdetail: function (e) {
      ...
      let url = app.globalData.url + '/purchase?action=getPurchaseDetail&table=cgmx'
      let data = new Object()
      data.table = "cgmx"
      data.purchaseidEQ = this.data.optionsitem.id
  ...
  submitreply: function () {
    ...
    let url = app.globalData.url + '/sp?action=doSp&table=cgd'
    let data = new Object()
