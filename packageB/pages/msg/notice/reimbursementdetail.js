...
Page({
  ...
  reimbursement: function () {
    ...
    let url = app.globalData.url + '/costapply?action=getDetailReimBeans&table=fybx'
    let data = new Object()
  ...
  //费用报销图片获取
  reimbursementimg: function () {
    wx.showLoading({
      title: '加载中',
      icon: 'none'
    })
    let url = app.globalData.url + '/costapply?action=searchcostPic'
    let data = new Object()
    data.costid = this.data.id
    app.wxRequest("POST", url, {
      "data": JSON.stringify(data)
    }, (res) => {
      console.log(res, data, url)
      this.setData({
        reimbursementimg: res.data
      })
      wx.hideLoading()
    }, (err) => {
      console.log(err)
  ...
  preview(event) {
    ...
    let currentUrl = event.currentTarget.dataset.imgdata
    console.log(event.currentTarget.dataset.imgdata)
    let arr = []
    arr.push(event.currentTarget.dataset.imgdata)
    console.log(arr)
    this.setData({
      imgdata: arr
    })
  ...
  approvalstatus: function () {
    ...
    if (this.data.speciallyapproved) {
      // let stat = this.data.speciallyapprovedshow
      // console.log(stat)
      this.setData({
  ...
  submitreply: function () {
    ...
    let url = app.globalData.url + '/sp?action=doSp&table=fybx'
    let data = new Object()
  ...
  //     title: '加载中...',
  //   })
  //   let url = app.globalData.url + '/order?action=toAudit'
  //   let data = new Object()
  //   data.idEQ = this.data.id
  //   app.wxRequest("POST", url, {
  //     "params": JSON.stringify(data)
